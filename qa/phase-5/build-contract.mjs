...
const manifest={manifestVersion:1,phase:'5',baseCommit:'48fcc560336b3e716c728c818fe22274f2f2b410',productionCommit:'92d400ea9e88162f845519b8d5e31ef771bac282',sourceRevisions:phaseFour.sourceRevisions,artifact:{sha256:hash(artifact),byteLength:artifact.length,embeddedAssetLinesSha256:hash(embedded)},baseArtifact:{sha256:phaseFour.artifact.sha256,byteLength:phaseFour.artifact.byteLength,embeddedAssetLinesSha256:phaseFour.artifact.embeddedAssetLinesSha256},scenarios:{sha256:hash(scenarios),byteLength:scenarios.length},frozenHistoricalFiles};
