...
const manifest={manifestVersion:1,phase:'4',baseCommit:'165d18aaab66370ac959670ef1c7284c6ec95a3c',productionCommit:'abe3fc5a72dd4585b57d11f1f72548c9411e256e',sourceRevisions:phaseThree.sourceRevisions,artifact:{sha256:hash(artifact),byteLength:artifact.length,embeddedAssetLinesSha256:hash(embedded)},baseArtifact:{sha256:phaseThree.artifact.sha256,byteLength:phaseThree.artifact.byteLength,embeddedAssetLinesSha256:phaseThree.artifact.embeddedAssetLinesSha256},scenarios:{sha256:hash(scenarios),byteLength:scenarios.length},frozenHistoricalFiles};
