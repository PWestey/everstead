...
const invariantById={
 ...
 'invariant-53-no-double-reward':rewardMutationsRejected&&allBundles.every(bundle=>bundle.safety.resourceAccounting.noDuplicateRewards&&bundle.safety.resourceAccounting.noLostResources&&bundle.safety.resourceAccounting.campaignNoReplay&&bundle.safety.resourceAccounting.rewardedNonFirstClearReceipts.length===0&&bundle.safety.resourceAccounting.duplicateRewardIds.length===0&&bundle.safety.resourceAccounting.lostResources.length===0&&bundle.safety.resourceAccounting.idleRewardProof.valid&&bundle.safety.resourceAccounting.idleRewardProof.duplicateCount===0&&bundle.safety.resourceAccounting.idleRewardProof.missingCount===0&&bundle.safety.resourceAccounting.idleRewardProof.unexpectedCount===0&&bundle.safety.resourceAccounting.idleRewardProof.awardsMatch&&bundle.progression.campaign.noReplayProof.valid&&bundle.progression.campaign.noReplayProof.campaignAwardsMatch&&Object.values(bundle.progression.campaign.noReplayProof.lanes).every(lane=>lane.uniqueNaturalIds&&lane.blockedZero&&lane.endingMatches&&lane.spendMatches&&lane.postCapNoReceipt)),
