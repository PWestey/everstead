...
if(process.argv.includes('--write')){
  const scenarios=identity('qa/phase-10c3/scenarios.json'),manifest={manifestVersion:1,phase:'10C-3',status:'PASS_LOCAL_EXPANDED',baseCommit:BASE,engineCommit:ENGINE,candidateCommit:CANDIDATE,productionChanged:true,browserFiles:true,artifact,scenarios,selectedProfile:{id:'everstead-economy-v1',identity:'6abf706b4450f61a708a0baba5e431a374f8de085fbf614e7334b6071bca534f'},privateGoldCore:{sha256:'6c309bc7e4a7e28e8336c29f2fea4366d47bf89642afabbf5abe6d0bb985ef8b',byteLength:10630},embeddedAssets:{count:5,aggregateSha256:'26d0c15d43ab9f7f98467f22f51aab8336f78ae84a016abc981733f7d5df5e7a'},schemaRows:47,engineRows:100,uiProbeRows:19,liveRows:86,viewports:['320x568','390x667','390x844'],packageFiles:Object.fromEntries(SOURCE_FILES.map(path=>[path,identity(path)])),expectedGate:{focusedCli:'143/143 twice',liveBrowser:'86/86 twice with zero console warnings/errors and zero native-storage writes'},observedGate:{focusedCli:{total:143,passed:143,failed:0,runs:2},predecessorLiveBrowser:{total:79,passed:79,failed:0,runs:2,viewports:['320x568','390x667','390x844'],consoleWarningsOrErrors:0,nativeStorageAccesses:0,observedAt:'2026-08-30T19:04:27Z'},expandedLiveBrowser:{total:86,passed:86,failed:0,runs:2,viewports:['320x568','390x667','390x844'],consoleWarningsOrErrors:0,nativeStorageAccesses:0,observedAt:'2026-08-30T19:23:19Z'}}};
