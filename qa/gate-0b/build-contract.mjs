...
const fixtureFiles = [
  ...
  'qa/gate-0b/fixtures/invalid-current-featured-ref.txt',
  'qa/gate-0b/fixtures/invalid-current-focus-ref.txt',
  'qa/gate-0b/fixtures/invalid-current-operator-ref.txt',
  'qa/gate-0b/fixtures/invalid-current-companion-ref.txt',
  'qa/gate-0b/fixtures/invalid-current-trade-member-ref.txt',
  'qa/gate-0b/fixtures/invalid-current-trade-shape.txt',
  'qa/gate-0b/fixtures/invalid-current-operation-ref.txt',
  'qa/gate-0b/fixtures/invalid-current-undo-oath-ref.txt',
  'qa/gate-0b/fixtures/invalid-current-undo-building-ref.txt',
  'qa/gate-0b/fixtures/invalid-current-undo-fellow-ref.txt',
  'qa/gate-0b/fixtures/invalid-current-undo-family-ref.txt',
  'qa/gate-0b/fixtures/invalid-current-undo-done-key.txt',
  'qa/gate-0b/fixtures/invalid-current-undo-resolve-value.txt',
  'qa/gate-0b/fixtures/invalid-current-undo-expected-value.txt',
