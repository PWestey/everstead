...
const nextMarker='/* Phase 11B-2b · journaled installation, rollback, and interrupted-operation recovery. */';
const start=source.indexOf(marker),end=source.indexOf(nextMarker,start),block=start>=0&&end>start?source.slice(start,end):'';
