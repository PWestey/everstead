...
The deployed app is an active **Limited Public Preview** on schema 14. It includes Oaths, passive Village growth, all 18 Fellows, all 20 Family members, all 20 Companions, Fellow Campaign, Fellow Expedition, Companion Campaign, Companion Tower, the First Covenant opening, gradual tutorials, protected Save & Recovery, and the first permanent Collection release, The Founding Table.
