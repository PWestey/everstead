...
Fast repaired-candidate diagnostics show exact rejection of foreign, own-`undefined`, negative-zero, reordered, and changed canonical inputs; exact production-order Gold grouping at the one-ULP discriminating boundary; all 240 valid direct-production vectors accepted; every loop-driving production-probe input bounded before selector execution; Date and pending-Gold additions checked at exact boundaries; and non-finite Campaign intermediates refused before JSON normalization. All 144 bundles are free of bad Gold conservation, Campaign replay, idle reward, duplicate-resource, or lost-resource results. Eight verifier-only corruptions—wrong Campaign target/Gift/sequence, forged roster Power/cost/matching spend, and duplicate/missing/misdirected/settlement-forged idle events—are independently detected. The accepted verifier retains unconditional full 203-predecessor no-write coverage; the parent will run it from a fully materialized clone. This is writer implementation evidence, not final acceptance evidence.
...
- Frozen advisory report: exact 144 complete bundles; report identity `a23d26cd488288f0125c6fa45f89a04b4c0a22cc12976f8c1e97cd4764742828`, file SHA-256 `a783944872a6e055f69cdba86ef8a5f192520ce373a2c6a2d18b5f78c2b66c4e`, exact byte length 94,525,580, and 210,773 explicit exact Float64 wrappers.
