...
Before increasing `CURRENT_SCHEMA_VERSION` beyond 12, the release must:

1. Preserve byte-exact schema-12 recovery fixtures exported by the released application.
...
8. Cover schema-12 import into the new schema across success, cancellation, quota failure, interruption, rollback, reload, and cross-tab interference.
